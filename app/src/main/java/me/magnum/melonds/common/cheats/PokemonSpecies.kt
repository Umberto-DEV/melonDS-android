...
/** National Pokédex 001–493. Names also used by the SGP 1.2.1 cheat catalogue. */
data class PokemonSpecies(val number: Int, val name: String) {
    ...
    companion object {
        ...
        val all: List<PokemonSpecies> = listOf(
            ...
            "Shaymin",
            "Arceus"
        ).mapIndexed { index, name -> PokemonSpecies(index + 1, name) }
    }
}
